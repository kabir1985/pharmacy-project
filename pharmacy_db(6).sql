...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2026 at 05:30 PM
...
CREATE TABLE `return_sales` (
  ...
  `sales_invoice` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` bigint UNSIGNED DEFAULT NULL,
  `return_date` date NOT NULL,
  `return_type` enum('FULL','PARTIAL') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `return_status` enum('PENDING','APPROVED','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'APPROVED',
...
INSERT INTO `sales` (`sales_id`, `sales_invoice`, `customer_id`, `sales_date`, `payment_type`, `total_amount`, `product_discount`, `product_vat`, `other_charge_on_all`, `paid_amount`, `payment_status`, `seller_id`, `return_status`, `created_at`, `updated_at`) VALUES
(824, 'INV26210B35B9', 13, '2026-07-29 08:19:34', 'Cash', 39.14, 2.06, 0.00, 0.00, 9.00, 'Partial', 18, '', '2026-07-29 14:19:34', '2026-07-29 16:30:11');
...
--
ALTER TABLE `customer_due`
  MODIFY `due_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `sales`
  MODIFY `sales_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=825;

--
-- AUTO_INCREMENT for table `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1261;

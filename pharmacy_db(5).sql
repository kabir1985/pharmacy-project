...
--
-- Host: localhost:3306
-- Generation Time: Jul 28, 2026 at 10:16 AM
...
CREATE TABLE `return_sales` (
  ...
  `sales_invoice` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` bigint UNSIGNED DEFAULT NULL,
  `return_date` date NOT NULL,
  `return_type` enum('FULL','PARTIAL') COLLATE utf8mb4_unicode_ci NOT NULL,
  `return_status` enum('PENDING','APPROVED','CANCELLED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'APPROVED',
  `total_return_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `refund_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `adjust_due_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `return_reason` text COLLATE utf8mb4_unicode_ci,
  `remarks` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `return_by` bigint UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `return_sales_details` (
  ...
  `sales_details_invoice` varchar(100) NOT NULL,
...
(823, 'INV26209484CD', 15, '2026-07-28 04:15:58', 'Cash', 1.20, 0.00, 0.00, 0.00, 0.00, 1.20, 18, '', '2026-07-28 10:15:58');
...
INSERT INTO `sales_details` (`sales_details_id`, `sales_details_invoice`, `product_id`, `product_quantity_sold`, `returned_qty`, `unit_price`, `total_sale_price`, `total_buy_price`) VALUES
(1252, 'INV26208500BD', 573, 1.00, 0.00, 1.20, 1.20, 1.00),
(1253, 'INV26208500BD', 574, 1.00, 0.00, 40.00, 40.00, 33.00),
(1254, 'INV26208500BD', 575, 1.00, 0.00, 45.00, 45.00, 34.00),
(1255, 'INV26208500BD', 576, 1.00, 0.00, 25.00, 25.00, 20.00),
(1256, 'INV26208B8A92', 573, 1.00, 0.00, 1.20, 1.20, 1.00),
(1257, 'INV26208B8A92', 574, 1.00, 0.00, 40.00, 40.00, 33.00),
(1258, 'INV26209484CD', 573, 1.00, 0.00, 1.20, 1.20, 1.00);
...
ALTER TABLE `return_sales`
  ...
  ADD KEY `idx_sales_invoice` (`sales_invoice`),
...
ALTER TABLE `return_sales_details`
  ...
  ADD KEY `product_id` (`product_id`),
  ADD KEY `sales_invoice` (`sales_invoice`),
  ADD KEY `sales_details_invoice` (`sales_details_invoice`);
...
ALTER TABLE `sales_details`
  ...
  ADD KEY `idx_invoice` (`sales_details_invoice`),
...
--
ALTER TABLE `customer_due`
  MODIFY `due_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `sales`
  MODIFY `sales_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=824;

--
-- AUTO_INCREMENT for table `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1259;

...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2026 at 06:37 AM
...
(771, 'INV26191D02AC', '15', '2026-07-10 06:15:52', 'Cash', 31.20, 10.00, 0.00, 0.00, 0.00, 31.20, 18, 'PARTIAL', '2026-07-10 12:15:52'),
(772, 'INV261914A4CC', '15', '2026-07-10 06:16:56', 'Cash', 33.20, 10.00, 0.00, 2.00, 0.00, 33.20, 18, 'FULL', '2026-07-10 12:16:56'),
...
--
ALTER TABLE `return_customer_due`
  MODIFY `due_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT for table `return_sales`
--
ALTER TABLE `return_sales`
  MODIFY `return_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

--
-- AUTO_INCREMENT for table `return_sales_details`
--
ALTER TABLE `return_sales_details`
  MODIFY `return_detail_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

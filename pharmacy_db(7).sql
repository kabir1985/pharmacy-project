...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2026 at 04:20 PM
...
(430, '2026-04-24', '15', 'INV2611482C99', 1, 0, 0),
(431, '2026-04-24', '15', 'INV261149E820', 7, 0, 0);
...
(105, 'INV261133B29A', '15', '2026-04-23 16:08:14', 'Cash', '0', '0', 0.00, 1.20, '18', 'FULL'),
(106, 'INV26114524CE', '15', '2026-04-24 16:00:23', 'Cash', '0', '0', 0.23, 1.00, '18', 'FULL'),
(107, 'INV2611482C99', '15', '2026-04-24 16:06:57', 'Cash', '0', '0', 0.00, 1.20, '18', 'FULL');
...
(91, 'INV261133B29A', '562', 1, 1.20, 1, 1.00, 0, 0),
(92, 'INV26114524CE', '562', 1, 1.20, 1, 1.00, 1, 0),
(93, 'INV2611482C99', '562', 1, 1.20, 1, 1.00, 0, 0);
...
(715, 'INV2611482C99', '15', '2026-04-24 10:06:57', 'Cash', 0, 0, 0.00, 1.20, '18', 'FULL'),
(716, 'INV261149E820', '15', '2026-04-24 10:53:04', 'Cash', 0, 0, 0.00, 7.20, '18', 'ACTIVE');
...
(1046, 'INV2611482C99', 562, 1, 1.20, 1, 1, 0, 0),
(1047, 'INV261149E820', 562, 6, 1.20, 6, 7, 0, 0);
...
--
ALTER TABLE `customer_due`
  MODIFY `due_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=432;
...
--
ALTER TABLE `return_customer_due`
  MODIFY `due_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;

--
-- AUTO_INCREMENT for table `return_sales`
--
ALTER TABLE `return_sales`
  MODIFY `sales_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `return_sales_details`
--
ALTER TABLE `return_sales_details`
  MODIFY `sales_details_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;

--
-- AUTO_INCREMENT for table `sales`
--
ALTER TABLE `sales`
  MODIFY `sales_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=717;

--
-- AUTO_INCREMENT for table `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1048;

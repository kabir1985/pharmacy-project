...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2026 at 02:10 AM
...
(11, 7, 106, '2026-08-31', 500.00, 5.00, 'without_tax', 11, 0.00, 1.00, 0.00, 1.00, 30.00, 1.30, '2026-08-01', 'test', 18, 'active', '2026-08-01 10:56:56', '2026-08-01 10:56:56');
...
INSERT INTO `stock_ledger` (`id`, `product_id`, `transaction_type`, `reference_id`, `qty_in`, `qty_out`, `balance_qty`, `unit_cost`, `transaction_date`, `remarks`, `created_by`) VALUES
(19, 7, 'OPENING', 11, 505.00, 0.00, 505.00, 1.00, '2026-08-01 00:00:00', 'Opening Stock', '18');
...
ALTER TABLE `product_opening_stock`
  ...
  ADD UNIQUE KEY `uk_product_batch` (`product_id`),

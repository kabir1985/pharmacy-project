...
INSERT INTO `product_purchase_details` (`purchase_details_id`, `purchase_id`, `product_id`, `expiry_date`, `quantity_per_pack`, `box_quantity`, `free_qty`, `base_price_per_unit`, `tax_id`, `tax_percentage`, `product_wise_vat_amount`, `product_wise_discount_amount`, `selling_price`, `purchase_price`, `line_total`, `created_at`, `updated_at`) VALUES
(2, 126, 7, NULL, 100.00, 1.00, 5.00, 1.00, 8, 5.00, 4.90, 2.00, 2.50, 2.10, 102.90, '2026-08-02 16:07:01', '2026-08-02 16:07:01');
...
--
ALTER TABLE `customer_due`
  MODIFY `due_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `product_purchase`
  MODIFY `purchase_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;

--
-- AUTO_INCREMENT for table `product_purchase_details`
--
ALTER TABLE `product_purchase_details`
  MODIFY `purchase_details_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sales`
  MODIFY `sales_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=837;

--
-- AUTO_INCREMENT for table `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1286;

--
-- AUTO_INCREMENT for table `stock_adjustment`
--
ALTER TABLE `stock_adjustment`
  MODIFY `adjustment_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

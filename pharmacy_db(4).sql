...
--
-- Host: localhost:3306
-- Generation Time: Jul 15, 2026 at 09:32 AM
...
INSERT INTO `stock_adjustment` (`adjustment_id`, `adjustment_no`, `adjustment_date`, `adjustment_type`, `reason`, `reference_no`, `remarks`, `adjusted_by`, `created_at`) VALUES
(1, 'SA-000001', '2026-07-15', '', 'Other', '123', 'test', 18, '2026-07-15 07:00:27');
...
INSERT INTO `stock_adjustment_details` (`id`, `adjustment_no`, `product_id`, `current_stock`, `adjustment_qty`, `new_stock`, `unit_cost`, `created_at`) VALUES
(1, 'SA-000001', 573, 5224.00, 2.00, 5226.00, 0.00, '2026-07-15 07:00:27');
...
--
ALTER TABLE `stock_adjustment`
  MODIFY `adjustment_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

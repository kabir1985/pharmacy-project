...
--
-- Host: localhost:3306
-- Generation Time: Jun 25, 2026 at 10:11 AM
...
(168, 'PUR261449C4A1', 569, 1, 1, 100.00, 5.00, 0.00, 105.00),
(169, 'PUR26144F81B3', 569, 1, 1, 100.00, 5.00, 0.00, 105.00),
(170, 'PUR26175B471F', 570, 10, 10, 75.00, 750.00, 0.00, 8250.00);
...
--
ALTER TABLE `product_purchase`
  MODIFY `product_purchase_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;

--
-- AUTO_INCREMENT for table `product_purchase_details`
--
ALTER TABLE `product_purchase_details`
  MODIFY `purchase_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

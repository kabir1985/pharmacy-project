/*
 * jQuery shoping cart - v1.9 - 2019-12-06
 * http://kabir.com
 * Copyright (c) Kabir Hossain; Licensed None
 */
...
(function($) {
  ...
  var loadMyCartEvent = function(targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      ...
      $("#cart_details").append(
        '<table class="table table-hover table-responsive" id="' +
          idCartTable +
          '"></table>' +
          '<button disabled type="button" class="btn btn-info float-right btnForCheckout ' +
          classCheckoutCart +
          '">Place Order</button>'
      );
    }
    ...
    var drawTable = function() {
      ...
      $(".btnForCheckout").attr("disabled", products.length > 0 ? false : true);
    ...
    */
    ...
    $(document).on("click", "." + classProductRemove, function() {
      ...
      $tr.hide(500, function() {
        ...
        drawTable();
        var quantity = ProductManager.getTotalQuantity();
        $cartBadge.text(quantity);

        $(".btnForCheckout").attr("disabled", quantity == 0 ? true : false);

        // if(ProductManager.getTotalQuantity()<1){
        // $(".btnForCheckout").attr("disabled",true);
        // }else{
    ...
    $(document).on("click", "." + classCheckoutCart, function() {
      ...
      if('my-cart-checkout'==classCheckoutCart){

        
        drawTable();
      }
      //console.log("Fire "+classCheckoutCart);
    });
    ...
    $(document).on("click", targetSelector, function() {
      ...
      $(".my-cart-badge").trigger("click");
    });
  };

  $.fn.myCart = function(userOptions) {
    OptionManager.loadOptions(userOptions);
    // console.log(this.selector, "RZR");

                ...
                <div class='table-responsive'>
                    <table class="table table-bordered table-sm dt-responsive nowrap" id="sampleTable" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img src="<?= base_url('public/uploads/' . $product['product_image']) ?>"
                                        alt="<?= esc($product['product_name']) ?>" class="img-thumbnail product-thumb">
                                </td>
                                <td class="product-name"><?= esc($product['product_name']) ?></td>
                                <td><?= esc($product['category_name']) ?></td>
                                <td><?= esc($product['productinitial_quantity']) ?></td>
                                <td><?= esc($product['cost_without_vat']) ?></td>
                                <td><?= esc($product['tax_percentage']) ?>%</td>
                                <td><?= esc($product['tax_amount']) ?></td>
                                <td><?= esc($product['purchase_price']) ?></td>
                                <td><?= esc($product['profit_margin_%']) ?></td>
                                <td><?= esc($product['sales_price_for_customer']) ?></td>
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="#" class="btn btn-primary btn-sm btn-edit"
                                            ...
                                            data-productinitial_quantity="<?= esc($product['productinitial_quantity']) ?>"
                                            data-base_price="<?= esc($product['base_price']) ?>"
                                            data-codefor_barcode="<?= esc($product['codefor_barcode']) ?>"
                                            data-alert_quantity="<?= esc($product['alert_quantity']) ?>">
                                            <i class="fa fa-edit"></i></a>
                                        <a href="#" class="btn btn-danger btn-sm btn-delete"
                                            data-delete_id="<?= esc($product['product_id']) ?>"><i

...
<div class='modal fade' id='SubCategoryAdd' tabindex='-1' role='dialog' aria-labelledby='SubCategoryAdd' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="expense_sub_category_add_form" method='post' action="<?= site_url('ExpensesubcategoryAdd') ?>" class="was-validated">
...
<div class='modal fade' id='ExpenseSubCategoryEditModal' tabindex='-1' role='dialog' aria-labelledby='ExpenseSubCategoryEditModal' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="expense_sub_category_edit_form" method='post' action="<?= site_url('ExpensesubcategoryUpdate') ?>">
                <div class='modal-header'>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('ExpensesubcategoryDelete') ?>" method="post">
                <div class="modal-footer">

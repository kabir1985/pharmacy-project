                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm btn-edit" data-expense_id="<?php echo $rows['expense_id'] ?>" data-expense_ref_no="<?php echo $rows['expense_ref_no'] ?>" data-expense_category_name="<?php echo $rows['expense_category_name'] ?>" data-expense_sub_category_name="<?php echo $rows['expense_sub_category_name'] ?>" data-expense_what_for="<?php echo $rows['expense_what_for'] ?>" data-expense_amount="<?php echo $rows['expense_amount'] ?>" data-expense_note="<?php echo $rows['expense_note'] ?>" data-expense_date="<?php echo $rows['expense_date'] ?>" data-expense_category_id="<?php echo $rows['expense_category']?>" data-expense_sub_category_id="<?php echo $rows['expense_sub_category']?>"><i class="fa fa-edit"></i></a>

                                        <a href="#" class="btn btn-danger btn-sm btn-delete" data-delete_id="<?php echo $rows['expense_id'] ?>"><i class="fa fa-trash-o"></i></a>
            ...
            <form id="Expense_add_submit_form" method='post' action="<?= site_url('ExpenseAdd') ?>">
                ...
                <div class='modal-body'>
                    ...
                    <div class='form-row'>
                        <div class='form-group col-md-6'>
                            <label>Amount</label>
                            <input required type='text' required class='form-control' onkeypress="return accept_digit_only(event)" name='expense_amount' placeholder='Expense Amount'>
                        </div>
                        <div class='form-group col-md-6'>
                            <label>Note</label>
            ...
            <form id="expense_update_submit_form" method='post' action="<?= site_url('ExpenseUpdate') ?>">
                ...
                <div class='modal-body' id="#">
                    ...
                    <div class='form-row'>
                        ...
                        <div class='form-group col-md-6'>
                            <label>What For</label>
                            <input type='text' class='form-control' required name='expense_what_for' id="expense_what_for">
                        </div>
                    </div>
                    ...
                    <div class='form-row'>
                        <div class='form-group col-md-6'>
                            ...
                            <input type='text' required class='form-control' onkeypress="return accept_digit_only(event)" name='expense_amount' id="expense_amount">
                        </div>
                        <div class='form-group col-md-6'>
    ...
    $(document).ready(function() {
        ...
        $('.btn-edit').on('click', function() {
           ...
           var expense_sub_category_id = $(this).data('expense_sub_category_id');
            $("#expense_sub_category_name option[value=expense_sub_category_id]").attr('selected', 'selected');
